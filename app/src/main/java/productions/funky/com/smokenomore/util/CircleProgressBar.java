...
public class CircleProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setTypeface(Typeface.createFromAsset(this.getResources().getAssets(), "LaneNarrow.ttf"));
        textPaint.setColor(color);
        Rect bounds = new Rect();
        double desiredTextSize = 0.5 * rectF.width();
        textPaint.setTextSize((float)desiredTextSize);
